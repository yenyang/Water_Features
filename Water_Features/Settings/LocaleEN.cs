...
namespace Water_Features.Settings
{
    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        /// </summary>
        /// <param name="setting">Water Features mod settings.</param>
        public LocaleEN(WaterFeaturesSettings setting)
        {
            ...
            m_Localization = new Dictionary<string, string>()
            {
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(WaterFeaturesSettings.WaterCausesDamage)), "Water Causes Flooding and Damage" },
                { m_Setting.GetOptionDescLocaleID(nameof(WaterFeaturesSettings.WaterCausesDamage)), "Enables or disables the Vanilla Water Damage and Submerge Systems. This is saved per save game. When toggled off, removes all flooding and damage from flooded buildings that are not yet destroyed." },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(WaterFeaturesSettings.Fluidness)), "Fluidness" },
                { m_Setting.GetOptionDescLocaleID(nameof(WaterFeaturesSettings.Fluidness)), "Alter the Fluidness factor of the water system. It should change the flow characteristics. This can create small waves, cause flooding, or cause instabilities and spikes in the water system." },
